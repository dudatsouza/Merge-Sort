...
## 📊 Implementação
Foi implementado o algoritmo Merge Sort de acordo com o pseudocódigo que está no [README.md](../../README.md) principal. Foram feitas algumas modificações para que o algoritmo pudesse ser executado em JavaScript. Veja abaixo algumas informações sobre a implementação:

- **Bibliotecas**: Foram utilizadas as bibliotecas `fs` e `readline` para manipulação de arquivos e leitura de dados do terminal.
...
## 📈 Resultados
Os resultados do desempenho do algoritmo da linguagem JavaScript, foram discutidos no artigo do projeto. Para mais informações, acesse o nosso [artigo](../../artigo/Artigo.pdf) ou o [README.md](../../README.md) principal.
<p align="right"><a href="#-implementação-em-javascript">⬆️ Voltar para ao Início</a></p>
