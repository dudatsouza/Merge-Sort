...
# Carregar os dados do arquivo CSV da linha 337 em diante
...
for linguagem in linguagens:
    ...
    if linguagem == 'Compiladas':
        file_name = f"../../../datasets/graphs/by_language_type/performance_compiled.png"
    else:
        file_name = f"../../../datasets/graphs/by_language_type/performance_interpreted.png"
